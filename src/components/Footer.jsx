        ...
        <div className="max-w-7xl mx-auto w-full">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-2xl">
              ...
              />
              <button className="subscribe-btn group relative inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-black overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-white/10 font-['Manrope'] text-sm font-medium">
            ...
            <div ref={el => columnsRef.current[3] = el} className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 group">
                  ...
                  <a href="tel:+91123456789" className="footer-link font-['Manrope'] text-gray-300 hover:text-white transition-colors duration-300 text-sm">
                    +91 123 456789
                  </a>
                </div>
                ...
                <div className="flex items-center gap-3 group">
                  ...
                  <a href="mailto:hello@domain.com" className="footer-link font-['Manrope'] text-gray-300 hover:text-white transition-colors duration-300 text-sm">
                    hello@domain.com
                  </a>
                </div>
